...
public abstract class AbstractDomainObject<T>
    ...
    protected final void fire( final String aEventID, final Object... aArguments )
        {
        fire( myListeners, aEventID, aArguments );
        }

    protected final void fire( final ArrayList aListeners, final String aEventID, final Object... aArguments )
        {
