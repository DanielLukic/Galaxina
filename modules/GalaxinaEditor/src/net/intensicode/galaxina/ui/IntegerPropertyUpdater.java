...
public final class IntegerPropertyUpdater extends TextFieldUpdater implements EditorStateListener, GroupEntryListener
    {
    public IntegerPropertyUpdater( final EditorCoreAPI aCoreAPI, final JTextField aTextField, final String aPropertyID, final String aStateID )
        {
    ...
    protected final void setNewValue( final String aNewValue )
        ...
        final Integer newValue = new Integer( aNewValue );
        final boolean changed = entry.setProperty( myPropertyID, newValue );
        if ( changed )
            {
